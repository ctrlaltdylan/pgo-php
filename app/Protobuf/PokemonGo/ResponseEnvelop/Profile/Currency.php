...
/**
 * Protobuf message : pokemongo.ResponseEnvelop.Profile.Currency
 */
class Currency extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->type === null) {
            throw new \UnexpectedValueException('Field "\\Protobuf\\PokemonGo\\ResponseEnvelop\\Profile\\Currency#type" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Protobuf\PokemonGo\ResponseEnvelop\Profile\Currency) {
